...
Calm, cinematic 3D portfolio system for Emirhan Kudun with Behance visuals, complete drawing archive, Q&A contact intake, deployment readiness, and a credential-aware SEIS runtime layer kept behind dedicated technical routes.
...
- `packages/content` - shared portfolio content, translations, drawings, Behance visuals, Behance embeds, social links, Q&A, software language metadata, and SEO metadata.
