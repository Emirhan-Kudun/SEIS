...
- Repository visibility audit: [`docs/repository-visibility-and-main-sync.md`](./docs/repository-visibility-and-main-sync.md)
...
- repository visibility audit and `main` branch mirror workflow
