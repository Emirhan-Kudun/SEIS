        ...
        <div className="contact-layout">
          ...
          <form className="brief-form" onSubmit={submitBrief}>
            ...
            <button className="primary-link" type="submit" disabled={briefState === "sending"}>
              {briefState === "sending" ? "Sending..." : dictionary.briefSubmit}
            </button>
            <p className="form-status" role="status">
              {briefState === "sent" && "Brief accepted into local runtime."}
              {briefState === "error" && "Brief could not be saved. Email fallback remains available."}
            </p>
          </form>
        </div>
      </section>
