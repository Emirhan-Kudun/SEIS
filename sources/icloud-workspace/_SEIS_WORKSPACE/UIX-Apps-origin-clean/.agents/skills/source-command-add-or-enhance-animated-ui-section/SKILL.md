---
name: "source-command-add-or-enhance-animated-ui-section"
description: "Workflow command scaffold for add-or-enhance-animated-ui-section in UIX-Apps."
---

# source-command-add-or-enhance-animated-ui-section

Use this skill when the user asks to run the migrated source command `add-or-enhance-animated-ui-section`.
