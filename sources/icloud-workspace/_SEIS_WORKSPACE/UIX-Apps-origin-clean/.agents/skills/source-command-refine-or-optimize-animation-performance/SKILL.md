---
name: "source-command-refine-or-optimize-animation-performance"
description: "Workflow command scaffold for refine-or-optimize-animation-performance in UIX-Apps."
---

# source-command-refine-or-optimize-animation-performance

Use this skill when the user asks to run the migrated source command `refine-or-optimize-animation-performance`.
