...
The local readiness minimum score is `85`, sourced from
`config/quality-gate-policy.json`. Release checks should preserve this minimum
instead of silently lowering the quality bar to make a shipment look ready.
