...
import { getRuntimeStoreSummary, readContactSubmissions } from "@/lib/runtime-store";
...
export async function GET(request: Request) {
  ...
  const [submissions, runtimeStore] = await Promise.all([readContactSubmissions(limit), getRuntimeStoreSummary()]);
