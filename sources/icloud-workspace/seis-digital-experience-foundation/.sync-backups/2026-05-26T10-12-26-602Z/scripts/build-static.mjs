...
copyDir("docs/development", join(staticDir, "docs/development"));
...
copyFile("deploy/provider-matrix.json", join(staticDir, "_deploy/provider-matrix.json"));
...
function writeReleaseFiles(targetDir) {
  ...
  const release = {
    ...
    providerMatrix: existsSync(join(targetDir, "_deploy/provider-matrix.json")),
