...
Bu belge, `codex/premium-local-foundation` branch'i uzerinde yarin website sprintine baslarken tek kaynak runbook olarak kullanilmak uzere hazirlandi.
...
- [ ] Calisma branch'i `codex/premium-local-foundation` mi
