...
import { ControlCenter } from "@/components/pages/control-center";
import { resolveLocale } from "@/lib/content";

export const metadata: Metadata = {
  title: "Control Center",
  description: "Unified control plane for search intelligence, release signals, and system manifest visibility.",
  alternates: {
    canonical: "/control"
  }
};
...
export default function ControlPage({ searchParams }: ControlPageProps) {
  ...
  return (
    <main className="min-h-screen bg-seis-bg text-seis-text">
      <section className="mx-auto w-[min(1100px,calc(100vw-1.5rem))] py-12 sm:py-16">
        <p className="text-xs uppercase tracking-[0.14em] text-seis-accent">SEIS Control</p>
        <h1 className="mt-3 max-w-4xl font-serif text-4xl leading-tight sm:text-5xl">
          Search intelligence, release readiness, and operating signals in one premium control surface.
        </h1>
        <p className="mt-4 max-w-3xl text-sm text-seis-muted sm:text-base">
          Designed for fast decision loops before production rollout: explore content, inspect release score, and verify system coverage.
        </p>
