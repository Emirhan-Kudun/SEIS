...
import { getRuntimeStoreSummary, readProjectBriefs } from "@/lib/runtime-store";
...
export async function GET(request: Request) {
  ...
  const [briefs, runtimeStore] = await Promise.all([readProjectBriefs(limit), getRuntimeStoreSummary()]);
