...
Calm, cinematic 3D portfolio and AI-native UI/UX Digital Lab system for Emirhan Kudun with Behance visuals, real Behance project iframe embeds, durable portfolio collections, a unified portfolio index, filterable drawing archive, broad product-interface lab coverage, Q&A contact intake, deployment readiness, and a credential-aware SEIS runtime layer kept behind dedicated technical routes.
...
- `/api/digital-lab` exposes the AI-native UI/UX Digital Lab surface map, capability stack, audience scenarios, engagement modes, Lovable-first prototype direction, and workflow sequence.
